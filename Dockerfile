...
#
#RUN uvicorn "app:app" --host="0.0.0.0" --port=5463
#RUN npm run serve
#
...
# docker run -p 3004:3000  -it -v E:\Applications\dataset-insights:/tmp/app gcr.io/viewo-g/piper/agent/local:0.0.1 bash
